...
* **RStudio**: **https://rstudio.com/products/rstudio/download/** <br> (get the free Desktop version, unless you have a spare $1K per year, or feel like running a server?)
...
* **R for Data Science (R4ds)**: **https://r4ds.had.co.nz/** <br> *Source code*: **https://github.com/hadley/r4ds** <br> This is co-written by Hadley Wickham, who is the author of the *tidyverse* family of R packages, and is an excellent reference which we will be using in the workshop.
