...
* [`r fa("github", height=15,fill="steelblue")` GitHub](https://github.com/onosson){target="_blank"}
* [`r fa("researchgate", height=15,fill="steelblue")` ResearchGate](https://www.researchgate.net/profile/Sky_Onosson){target="_blank"}
* [`r fa("linkedin",height=15, fill="steelblue")` LinkedIn](https://www.linkedin.com/in/sky-onosson-57902870/){target="_blank"}
* [`r fa("twitter", height=15, fill="steelblue")` Twitter](https://twitter.com/onosson){target="_blank"}
