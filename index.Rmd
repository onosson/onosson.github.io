...
<img src="images/hands.jpg" style="width:28%; border:2px solid; margin-right: 5px" align="right">

<big>

# Sky Onosson, Ph.D. [`r fa("envelope", fill="steelblue")`](mailto:sky@onosson.com) [`r fa("twitter", fill="steelblue")`](https://twitter.com/onosson){target="_blank"} [`r fa("facebook", fill="steelblue")`](https://www.facebook.com/onosson){target="_blank"} [`r fa("instagram", fill="steelblue")`](https://instagram.com/sky_onosson){target="_blank"}
...
And you can find me in all of the usual places --- [Twitter](https://twitter.com/onosson){target="_blank"}, [Facebook](https://www.facebook.com/onosson){target="_blank"} and [Instagram](https://instagram.com/sky_onosson){target="_blank"} --- where I post a mix of academic and personal stuff.
...
**Personal Address** <br>
Sky Onosson <br>
1039 Garfield St. N. <br>
Winnipeg MB Canada  R3E 2N7 <br> <br>
...
## My work in linguistics [`r fa("github", fill="steelblue")`](https://github.com/onosson){target="_blank"} [`r fa("researchgate", fill="steelblue")`](https://www.researchgate.net/profile/Sky_Onosson){target="_blank"} [`r fa("linkedin", fill="steelblue")`](https://www.linkedin.com/in/sky-onosson-57902870/){target="_blank"}
...
## Current position and previous experience [`r fa("file-alt", fill="steelblue")`](pdf/OnossonCV.pdf){target="_blank"}
...
## My research [`r fa("file-alt", fill="steelblue")`](pdf/OnossonCV.pdf){target="_blank"}
...
-|---|---
2020 | The effects of language contact on non-native vowel sequences in lexical borrowings: The case of Media Lengua (with Jesse Stewart) | Under revision
&nbsp; | The interaction of yod retention with /u/-fronting in Victoria | Under review
...
&nbsp; | Suppressing biases in correlate identification in acoustic data: The case of Media Lengua (with Jesse Stewart) | Under review
&nbsp; | [The effects of language contact on non-native diphthongs in lexical borrowings: The case of Media Lengua](pdf/Onosson,%20Stewart%20-%202020%20-%20Society%20for%20Pidgin%20and%20Creole%20Linguistics.pdf){target="_blank"} (with Jesse Stewart) | Society for Pidgin and Creole Linguistics, New Orleans LA
...
&nbsp; | Phonetic change in the grammaticalization of Brazilian Portuguese *tipo* (with Christiani Thompson) | In preparation
