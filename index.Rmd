...
<img src="images/me_thumb.jpg" style="width:35%; border:8px solid; margin-right: 25px" align="left">
...
### Contact and Social Media [`r fa("envelope", fill="steelblue")`](mailto:sky@onosson.com) [`r fa("researchgate", fill="steelblue")`](https://www.researchgate.net/profile/Sky_Onosson){target="_blank"}  [`r fa("github", fill="steelblue")`](https://github.com/onosson){target="_blank"}
...
### Current work and experience [`r fa("file-alt", fill="steelblue")`](pdf/OnossonCV2019.pdf){target="_blank"}
